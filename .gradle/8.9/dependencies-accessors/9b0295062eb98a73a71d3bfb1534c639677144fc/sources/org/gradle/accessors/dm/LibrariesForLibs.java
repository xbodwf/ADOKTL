...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final VulkanLibraryAccessors laccForVulkanLibraryAccessors = new VulkanLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>vulkan</b>
     */
    public VulkanLibraryAccessors getVulkan() {
        return laccForVulkanLibraryAccessors;
    }
    ...
    public static class LwjglLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>core</b> with <b>org.lwjgl:lwjgl</b> coordinates and
         * with version reference <b>lwjgl</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("lwjgl.core");
        }

        /**
         * Dependency provider for <b>glfw</b> with <b>org.lwjgl:lwjgl-glfw</b> coordinates and
         * with version reference <b>lwjgl</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGlfw() {
            return create("lwjgl.glfw");
        }

        /**
         * Dependency provider for <b>opengl</b> with <b>org.lwjgl:lwjgl-opengl</b> coordinates and
         * with version reference <b>lwjgl</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getOpengl() {
            return create("lwjgl.opengl");
        }

        /**
         * Dependency provider for <b>vulkan</b> with <b>org.lwjgl:lwjgl-vulkan</b> coordinates and
         * with version reference <b>lwjgl</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getVulkan() {
            return create("lwjgl.vulkan");
        }

    }

    public static class VulkanLibraryAccessors extends SubDependencyFactory {

        public VulkanLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>org.lwjgl:lwjgl-vulkan</b> coordinates and
         * with version reference <b>lwjgl</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("vulkan.core");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>lwjgl</b> with value <b>3.3.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLwjgl() { return getVersion("lwjgl"); }
        ...
        /**
         * Version alias <b>vulkan</b> with value <b>1.3.280</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVulkan() { return getVersion("vulkan"); }
